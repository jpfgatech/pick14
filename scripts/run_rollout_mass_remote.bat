...
REM Default: 10_000 deck configs × 8 reps = 80_000 games, ε=0.25, shards of 500 games.
...
C:\Users\Administrator\Documents\projects\venv\Scripts\python.exe -u scripts\05_rollout_mass.py --deck-configs 10000 --reps-per-deck 8 --explore-frac 0.25 --shard-every-games 500 --output-dir rollout_data >> rollout_mass_80k.log 2>&1
